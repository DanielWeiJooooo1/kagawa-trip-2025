...
最後更新：2026-07-17 23:10

## Objective
這個 repo 是 `2026 神戶岡山之旅` 的靜態網站。主頁仍保留原本高松網站，`trips/kobe-okayama-2026/` 則承載收藏編輯、手機 Trip Mode 與 concept demo。
...
- `tests/trip-mode.spec.js`：Trip Mode synthetic mobile acceptance
...
## Constraints
- 不修改根目錄 `index.html`
- 不接 Firebase、登入、多人同步、圖片上傳、地圖 SDK 或交通時間計算
